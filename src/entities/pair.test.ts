import { Token, WETH9, Price, CurrencyAmount } from '@huskyswap/sdk-core'
...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    ...
    expect(result).toEqual('0x585C13d17D5641f21Bb4699a792a362FCf2b58Cc')
  })
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x4F42CCbA97AD4BA76CdD56C0E03dF2aB49ffa246')
    })
  })
