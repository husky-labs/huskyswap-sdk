...
describe('Pair', () => {
  ...
  const DOGECHAIN_TESTNET_WWDOGE = new Token(ChainId.DOGECHAIN_TESTNET, '0xbA910a7E6D63212Cad7C14A9A946F283e7FE4a35', 18, 'WWDOGE', 'Wrapped WDOGE')
  const DOGECHAIN_TESTNET_DCV = new Token(ChainId.DOGECHAIN_TESTNET, '0x694988E7E39ada0FB8cd9aEAaCd818B2d2031250', 18, 'DCV', 'DCV')
